...
$descriptions = array(
                      ...
                      "wt" => "包含内部函数花费的时间<br>(微秒)",
                      "IWall%" => "调用的包括子函数所有花费时间的百分比%",
                      "excl_wt" => "不包含内部函数花费的时间<br>(User)",
                      "EWall%" => "函数执行本身花费的时间的百分比，不包括子树执行时间%",

                      "ut" => "不包含用户函数花费时间<br>(微秒)",
                      "IUser%" => "IUser%",
                      ...
                      "cpu" => "包含系统函数CUP花销时间. CPU<br>(微秒)",
                      "ICpu%" => "Incl. CPU(microsecs)的百分比%",
                      "excl_cpu" => "不包含系统函数CPU花销时间<br>(微秒)",
                      "ECpu%" => "Excl. CPU(microsec)的百分比%",

                      "mu" => "包含内部函数所占内存(字节)",
                      "IMUse%" => "Incl.MemUse(bytes)的百分比%",
                      "excl_mu" => "不包含内部函数所占内存(字节)",
                      "EMUse%" => "EMemUse% 峰值百分比%",

                      "pmu" => "包含内部函数所占内存峰值<br>(字节)",
                      "IPMUse%" => "Incl.PeakMemUse(bytes) 的峰值百分比%",
                      "excl_pmu" => "不包含内部函数所占内存峰值<br>(字节)",
                      "EPMUse%" => "EPeakMemUse峰值百分比%",
